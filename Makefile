...
$(MAIN): $(shell find src | grep .cr) Makefile src/link.ld src/arm-none-eabi/shim/shim.o
	...
	arm-none-eabi-gcc 'kernel.elf.o' ext/teensy-cores/teensy3/*.o ext/newlib/crt0.o ext/gcc/crtbegin.o src/arm-none-eabi/shim/shim.o -o 'kernel.elf' -nostdlib  -Wl,-T,/osc/mk20dx256.ld,--build-id=none    -L/usr/lib -L/usr/local/lib $(LIBC_LINK_FLAGS)
